...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1360: x0 => x0.play(),
      _1361: x0 => x0.load(),
      _1362: (x0,x1) => x0.removeAttribute(x1),
      _1363: (x0,x1) => x0.setSinkId(x1),
      ...
      _1401: x0 => new WeakRef(x0),
      _1402: x0 => x0.deref(),
      _1409: () => globalThis.WeakRef,
      _1413: s => JSON.stringify(s),
      _1414: s => printToConsole(s),
      ...
      _1426: Object.is,
      _1430: (o, c) => o instanceof c,
      _1431: o => Object.keys(o),
      _1433: (o,s,v) => o[s] = v,
      _1461: x0 => new Array(x0),
      _1463: x0 => x0.length,
      _1465: (x0,x1) => x0[x1],
      _1466: (x0,x1,x2) => { x0[x1] = x2 },
      _1469: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1471: x0 => new Int8Array(x0),
      _1472: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1474: x0 => new Uint8ClampedArray(x0),
      _1476: x0 => new Int16Array(x0),
      _1478: x0 => new Uint16Array(x0),
      _1480: x0 => new Int32Array(x0),
      _1482: x0 => new Uint32Array(x0),
      _1484: x0 => new Float32Array(x0),
      _1486: x0 => new Float64Array(x0),
      _1509: () => Symbol("jsBoxedDartObjectProperty"),
      _1510: x0 => x0.random(),
      _1511: (x0,x1) => x0.getRandomValues(x1),
      _1512: () => globalThis.crypto,
      _1513: () => globalThis.Math,
      _1526: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1527: (handle) => clearTimeout(handle),
      _1528: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1529: (handle) => clearInterval(handle),
      _1530: (c) =>
      ...
      _1548: o => o.length,
      _1550: (o, i) => o[i],
      _1551: f => f.dartFunction,
      _1552: () => ({}),
      _1553: () => [],
      _1555: () => globalThis,
      _1556: (constructor, args) => {
      ...
      _1558: (o, p) => o[p],
      _1559: (o, p, v) => o[p] = v,
      _1560: (o, m, a) => o[m].apply(o, a),
      _1562: o => String(o),
      _1563: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1564: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1564(f,arguments.length,x0) }),
      _1565: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1565(f,arguments.length,x0,x1) }),
      _1566: o => {
      ...
      _1567: o => [o],
      _1568: (o0, o1) => [o0, o1],
      _1569: (o0, o1, o2) => [o0, o1, o2],
      _1570: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1614: (x0,x1) => x0.item(x1),
      _1626: o => o instanceof Array,
      _1631: a => a.pop(),
      _1632: (a, i) => a.splice(i, 1),
      _1633: (a, s) => a.join(s),
      _1634: (a, s, e) => a.slice(s, e),
      _1636: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1637: a => a.length,
      _1639: (a, i) => a[i],
      _1640: (a, i, v) => a[i] = v,
      _1642: o => {
      ...
      _1643: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1645: o => o instanceof Uint8Array,
      _1646: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1647: o => o instanceof Int8Array,
      _1648: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1649: o => o instanceof Uint8ClampedArray,
      _1650: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1651: o => o instanceof Uint16Array,
      _1652: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1653: o => o instanceof Int16Array,
      _1654: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1655: o => o instanceof Uint32Array,
      _1656: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1657: o => o instanceof Int32Array,
      _1658: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1660: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1661: o => o instanceof Float32Array,
      _1662: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1663: o => o instanceof Float64Array,
      _1664: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1665: (t, s) => t.set(s),
      _1666: l => new DataView(new ArrayBuffer(l)),
      _1667: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1668: o => o.byteLength,
      _1669: o => o.buffer,
      _1670: o => o.byteOffset,
      _1671: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1672: (b, o) => new DataView(b, o),
      _1673: (b, o, l) => new DataView(b, o, l),
      _1674: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1675: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1676: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1677: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1678: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1679: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1680: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1681: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1682: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1683: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1684: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1685: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1688: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1689: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1690: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1691: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1692: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1693: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1694: Function.prototype.call.bind(Number.prototype.toString),
      _1695: Function.prototype.call.bind(BigInt.prototype.toString),
      _1696: Function.prototype.call.bind(Number.prototype.toString),
      _1697: (d, digits) => d.toFixed(digits),
      _2487: x0 => x0.error,
      _2488: x0 => x0.src,
      _2489: (x0,x1) => { x0.src = x1 },
      _2497: (x0,x1) => { x0.preload = x1 },
      _2498: x0 => x0.buffered,
      _2501: x0 => x0.currentTime,
      _2502: (x0,x1) => { x0.currentTime = x1 },
      _2503: x0 => x0.duration,
      _2508: (x0,x1) => { x0.playbackRate = x1 },
      _2521: (x0,x1) => { x0.volume = x1 },
      _2538: x0 => x0.code,
      _2539: x0 => x0.message,
      _2613: x0 => x0.length,
      _3117: (x0,x1) => { x0.src = x1 },
      _3119: (x0,x1) => { x0.type = x1 },
      _3137: (x0,x1) => { x0.charset = x1 },
      _3586: () => globalThis.window,
      _3649: x0 => x0.navigator,
      _4019: x0 => x0.geolocation,
      _4022: x0 => x0.mediaDevices,
      _4024: x0 => x0.permissions,
      _4089: x0 => x0.data,
      _4126: (x0,x1) => { x0.onmessage = x1 },
      _5634: x0 => x0.destination,
      _5638: x0 => x0.state,
      _5639: x0 => x0.audioWorklet,
      _5742: (x0,x1) => { x0.fftSize = x1 },
      _5743: x0 => x0.frequencyBinCount,
      _5745: (x0,x1) => { x0.minDecibels = x1 },
      _5747: (x0,x1) => { x0.maxDecibels = x1 },
      _5749: (x0,x1) => { x0.smoothingTimeConstant = x1 },
      _6003: x0 => x0.port,
      _6195: x0 => x0.length,
      ...
      _8202: x0 => x0.size,
      _8594: x0 => x0.mimeType,
      _8595: x0 => x0.state,
      _8599: (x0,x1) => { x0.onstop = x1 },
      _8601: (x0,x1) => { x0.ondataavailable = x1 },
      _8626: x0 => x0.data,
      _8850: x0 => x0.lang,
      _8851: (x0,x1) => { x0.lang = x1 },
      _8853: (x0,x1) => { x0.continuous = x1 },
      _8855: (x0,x1) => { x0.interimResults = x1 },
      _8863: (x0,x1) => { x0.onspeechstart = x1 },
      _8871: (x0,x1) => { x0.onresult = x1 },
      _8873: (x0,x1) => { x0.onnomatch = x1 },
      _8875: (x0,x1) => { x0.onerror = x1 },
      _8877: (x0,x1) => { x0.onstart = x1 },
      _8879: (x0,x1) => { x0.onend = x1 },
      _8880: x0 => x0.error,
      _8882: x0 => x0.transcript,
      _8883: x0 => x0.confidence,
      _8884: x0 => x0.length,
      _8886: x0 => x0.length,
      _8888: x0 => x0.results,
      _9104: x0 => x0.state,
      _9763: x0 => x0.sampleRate,
      _9775: x0 => x0.channelCount,
      _13055: () => globalThis.console,
